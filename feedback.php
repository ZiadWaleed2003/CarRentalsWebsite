...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Feedback <?php
...
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3">
        <h1 class="display-4 text-uppercase text-center mb-5">your Feedback</h1>
        <div class="row">
            <div class="col-lg-7 mb-2">
                <div class="contact-form bg-light mb-4" style="padding: 30px;">
                    <form action="feedbackhandle.php" method="post">
                        <div class="form-group">
                            <textarea class="form-control py-3 px-4" rows="5" placeholder="Feedback" required="required" name="feedback"></textarea>
                        </div>
                        <div>
